                ...
                if scene_name == desired_scene_name:
                    ...
                    for granule_idx in range(len(granules_paths)):
                        ...
                        if granule_idx == desired_granule_idx:
                            raw_coreg_granule,_,_ = SuperGlue_registration(bands_list=bands_list,event_path=scene_path,granule_idx=granule_idx)
