...
# from segthraws.model_training.main_run import main_train_test
from segthraws.model_training.training_scripts import model_train_test
...
if __name__ == '__main__':
    ...
    model_train_test(datasets_path = datasets_path,
