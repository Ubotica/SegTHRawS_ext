...
# bands_list_new = [ "B02", "B08", "B03", "B10","B04", "B05","B11", "B06", "B07","B8A","B12","B01"]
# bands_list = [ "B02", "B08", "B03", "B10","B04", "B05","B11", "B06", "B07u","B8A","B12","B01"]

End2End_database_path = '/home/cristopher/Documents/PyRawS/modifications_cristopher/THRAWS_END2END/'
...
directories = {
   ...
   'masks_potential_event_voting_2_path' :('masks', 'potential_event', 'comparison','voting_2'),
   'masks_potential_event_voting_3_path' :('masks', 'potential_event', 'comparison','voting_3'),
#    'masks_potential_event_voting_4_path' :('masks', 'potential_event', 'comparison','voting_4'),
#    'masks_potential_event_intersection_path' :('masks', 'potential_event', 'comparison','intersection'),
#    'masks_comparison_events_plot_voting_2_path' :('masks', 'event', 'comparison','comparison_plot','voting_2'),
#    'masks_comparison_events_plot_voting_3_path' :('masks', 'event', 'comparison','comparison_plot','voting_3'),
   'masks_comparison_events_plot_voting_4_path' :('masks', 'event', 'comparison','comparison_plot','voting_4'),
   'masks_comparison_events_plot_intersection_path' :('masks', 'event', 'comparison','comparison_plot','intersection'),
   'masks_comparison_potential_events_plot_voting_2_path' :('masks', 'potential_event', 'comparison','comparison_plot','voting_2'),
   'masks_comparison_potential_events_plot_voting_3_path' :('masks', 'potential_event', 'comparison','comparison_plot','voting_3'),
#    'masks_comparison_potential_events_plot_voting_4_path' :('masks', 'potential_event', 'comparison','comparison_plot','voting_4'), 
#    'masks_comparison_potential_events_plot_intersection_path' :('masks', 'potential_event', 'comparison','comparison_plot','intersection'),
...
masks_events_dirs = [paths_dict['Castro_Traba_events_path'],
...
masks_potential_events_dirs = [paths_dict['Castro_Traba_potential_events_path'],
...
plot_names = ['NIR_SWIR image','Castro-Traba','Massimetti','Murphy','Schroeder','Kumar-Roy','Voting 2','Voting 3',' Voting 4','Intersection']
