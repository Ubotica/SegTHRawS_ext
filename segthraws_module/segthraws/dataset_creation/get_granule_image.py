                ...
                if scene_name == desired_scene_name:
                    ...
                    for granule_idx in range(len(granules_paths)):
                        ...
                        if granule_idx == desired_granule_idx:
                            ...
                            NIR_SWIR_image = normalize_to_0_to_1(np.dstack((raw_coreg_granule[:,:,bands_list.index('B12')],raw_coreg_granule[:,:,bands_list.index('B11')],raw_coreg_granule[:,:,bands_list.index('B8A')])))
